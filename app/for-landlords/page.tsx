    ...
    <main style={{ backgroundColor: PAPER, color: INK, fontFamily: FONT, overflowX: 'hidden', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: 1080, margin: '0 auto', padding: '28px 24px 12px' }}>
        <div style={{ maxWidth: 760 }}>
          <span style={{ display: 'inline-block', backgroundColor: SAFFRON_TINT, color: ON_SAFFRON_TINT, fontSize: 12, fontWeight: 700, letterSpacing: '0.6px', padding: '6px 12px', borderRadius: 20, marginBottom: 18 }}>FOR LANDLORDS · READY FOR APRIL 2027</span>
      ...
      <section style={{ maxWidth: 1080, margin: '0 auto', padding: '10px 24px 30px' }}>
        <div style={{ background: SAFFRON_TINT, border: '1px solid #F1DBAE', borderRadius: 18, padding: '24px 26px' }}>
          ...
          <Link href="/landlord-tax-calculator" style={{ display: 'inline-block', marginTop: 14, color: ON_SAFFRON_TINT, fontSize: 15, fontWeight: 800 }}>Price it on your numbers now →</Link>
        </div>
      </section>
