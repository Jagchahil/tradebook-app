...
// 🔴 A SECOND FORMATTER IN THE SAME FILE AS THE ONE ABOVE, WITH THE SIGN INSIDE THE POUND AGAIN.
// Zero decimal places is gbp0 exactly, so there was never a reason for it to exist.
const gbpExact = (n: number) => gbp0(n);
