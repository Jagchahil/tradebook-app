    ...
    <main style={{ backgroundColor: PAPER, color: INK, fontFamily: FONT, overflowX: 'hidden' }}>
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto', padding: '26px 24px 6px' }}>
        <div style={{ maxWidth: 720 }}>
          <span style={{ display: 'inline-block', backgroundColor: GREEN_TINT, color: ON_GREEN_TINT, fontSize: 12, fontWeight: 700, letterSpacing: '0.6px', padding: '6px 12px', borderRadius: 20, marginBottom: 18 }}>FREE TOOL, NO SIGNUP</span>
