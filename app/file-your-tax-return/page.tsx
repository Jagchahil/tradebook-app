...
const steps = [
  ...
  {
    n: '2', key: 'gather', tint: SAFFRON_TINT, fg: ON_SAFFRON_TINT,
  ...
  {
    n: '5', key: 'maths', tint: SAFFRON_TINT, fg: ON_SAFFRON_TINT,
    ...
    return (
      <div className="wt-screen">
        ...
        <div style={{ padding: '18px 16px', minHeight: 168 }}>
          ...
          <div className="wtP" style={{ animationDelay: '1.55s', marginTop: 10, display: 'flex', alignItems: 'center', gap: 8, color: ON_GREEN_TINT, fontSize: 12.5, fontWeight: 600 }}><span>✓</span> Tax year 2025 to 2026</div>
        </div>
      </div>
    );
  }
      ...
      <div className="wt-screen">
        ...
        <div style={{ padding: '16px 16px', minHeight: 168 }}>
          ...
          <div style={{ height: 30, borderRadius: 8, background: SURFACE, overflow: 'hidden', marginTop: 5, position: 'relative' }}>
            ...
            <span className="wtP" style={{ animationDelay: '1.1s', position: 'absolute', right: 10, top: 5, fontSize: 13.5, fontWeight: 800, color: ON_GREEN_TINT }}>£9,250</span>
          </div>
  ...
  return (
    <main style={{ fontFamily: FONT, color: INK, background: PAPER, overflowX: 'hidden' }}>
      ...
      <section style={{ maxWidth: 820, margin: '0 auto', padding: '40px 24px 20px', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, backgroundColor: SAFFRON_TINT, color: ON_SAFFRON_TINT, fontSize: 13, fontWeight: 600, padding: '7px 14px', borderRadius: 20, marginBottom: 22 }}>
              ...
              <div key={s.n} className={`wt-panel wtp-${s.n}`}>
                <div className="wt-grid">
                  ...
                  <div>
                    ...
                    {s.tip ? <div style={{ marginTop: 14, background: SAFFRON_TINT, color: ON_SAFFRON_TINT, borderRadius: 10, padding: '11px 13px', fontSize: 13.5, lineHeight: 1.5 }}>💡 {s.tip}</div> : null}
                  </div>
                </div>
              </div>
            ))}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(220px,1fr))', gap: '8px 18px' }}>
              {universalExpenses.map((e) => (
                <div key={e} style={{ display: 'flex', gap: 9, alignItems: 'flex-start', fontSize: 14.5, color: INK }}>
                  <span style={{ color: ON_GREEN_TINT, fontWeight: 700 }}>&#10003;</span><span>{e}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="trade-panels">
              {trades.map((t) => (
                <div key={t.id} className={`trade-panel tp-${t.id}`} style={{ background: 'var(--panel)', border: `1px solid ${LINE}`, borderRadius: 16, padding: 24, maxWidth: 640, margin: '0 auto' }}>
                  ...
                  {t.cis && (
                    <p style={{ margin: '14px 0 0', padding: '12px 14px', background: SAFFRON_TINT, borderRadius: 10, color: ON_SAFFRON_TINT, fontSize: 14, lineHeight: 1.5 }}>
