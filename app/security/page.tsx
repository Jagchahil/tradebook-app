...
.sec-badge{display:inline-block;background:var(--teal-tint);color:var(--on-teal-tint);font-size:12px;font-weight:800;letter-spacing:.06em;padding:6px 12px;border-radius:20px;margin-bottom:16px}
...
.sec-card{background:var(--panel);border:1px solid var(--line);border-radius:16px;padding:20px}
...
.ai-list{background:var(--panel);border:1px solid var(--line);border-radius:16px;overflow:hidden}
  ...
  return (
    <main className="mkt" style={{ backgroundColor: PAPER, color: INK, fontFamily: FONT, overflowX: 'hidden' }}>
      ...
      <article className="sec-wrap reveal">
        ...
        <p className="sec-p">
          We follow UK GDPR, and Lekhio Ltd is registered with the Information Commissioner&apos;s Office as a data controller, reference ZC198977, which you can check on the public register at ico.org.uk. If you ever have a question about your data, email <a href="mailto:info@lekhio.app">info@lekhio.app</a>.
        </p>
