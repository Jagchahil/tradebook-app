...
export const freeTools = [
  ...
  { href: '/free-mtd-prep', icon: '🆓', title: 'Free MTD prep', body: 'A straightforward quarterly update, prepared free, forever. You send it. Join the list to be first.' },
];
    ...
    <footer className="sitefooter" style={{ background: INK_BG, color: '#fff' }}>
      <div style={{ maxWidth: 1320, margin: '0 auto', padding: '52px 24px 40px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(160px,1fr))', gap: 32, marginBottom: 40 }}>
          ...
          {col('Free tools', [['/tax-calculator', 'Tax calculator'], ['/cis-calculator', 'CIS refund calculator'], ['/mileage-calculator', 'Mileage calculator'], ['/landlord-tax-calculator', 'Landlord tax calculator'], ['/rent-a-room-checker', 'Rent a Room checker'], ['/sole-trader-vs-limited', 'Sole trader vs limited'], ['/invoice-generator', 'Invoice maker'], ['/ni-checker', 'NI checker'], ['/student-loan-checker', 'Student loan checker'], ['/can-i-claim', 'Can I claim it?'], ['/file-your-tax-return', 'File your return'], ['/free-mtd-prep', 'Free MTD prep'], ['/resources', 'All tools']])}
