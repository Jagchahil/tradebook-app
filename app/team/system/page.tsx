    ...
    <TeamShell title="Mistri · System">
      ...
      <section style={U.section}>
        <div style={U.sectionHead}>
          ...
          <span style={U.sectionNote}>moved</span>
        </div>
        <div style={U.honest}>
          The social connections live on <a href="/team/hoka" style={{ color: C.river, fontWeight: 650 }}>Hoka&rsquo;s desk</a> now.
          The accounts a marketer posts from belong on the marketer&rsquo;s page, not the CTO&rsquo;s.
        </div>
      </section>
