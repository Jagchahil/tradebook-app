...
.scard{border-radius:20px;padding:26px;text-align:center;border:1px solid var(--line);background:var(--panel)}
...
.ocard{background:var(--panel);border:1px solid var(--line);border-radius:20px;padding:22px}
.ocard h3{font-size:18px;margin:0 0 4px}
.ocard .otag{font-size:11px;font-weight:900;letter-spacing:.05em;color:var(--on-green-tint);background:var(--green-tint);padding:3px 9px;border-radius:999px;display:inline-block;margin-bottom:12px}
...
.tablewrap{background:var(--panel);border:1px solid var(--line);border-radius:20px;overflow:hidden}
...
.crown{font-size:9.5px;font-weight:900;letter-spacing:.04em;color:var(--on-saffron-tint);margin-top:3px}
      ...
      <section style={{ paddingTop: 20 }}>
        <div className="wrap">
          <div className="final reveal">
            ...
            <p>7 days free. No card needed. Cancel in one tap.</p>
