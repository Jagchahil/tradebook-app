...
// The workers that sit in the constellation and the report grid. Pehredaar (security), Kanjoos (cost)
// and Dakiya (inbound email) are the newest, added 20 Jul — 'waking'/'asleep' until their mini bots
// start reporting through the Bridge. Kaardaar and Munsif are on the roster (docs/115) but join the
// console once their trigger fires, so they are not drawn yet.
export const BUDDIES: BuddyDef[] = [
  ...
  { key: 'dakiya',    name: 'Dakiya',    role: 'Front Desk · Email',g1: '#2C7A7B', g2: '#48A9AA', status: 'waking', statusWord: 'warming up',  emblem: 'people',    href: '/team/dakiya',    reportsToList: 'approve' },
