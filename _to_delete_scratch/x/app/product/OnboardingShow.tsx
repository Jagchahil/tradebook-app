    ...
    <div>
      ...
      <div className="ob-grid">
        ...
        <div key={stage} className="ob-stagewrap">
          ...
          {stage === 3 ? (
            <div style={{ marginTop: 16, background: GREEN_TINT, border: '1px solid #CFE9D8', borderRadius: 12, padding: '12px 14px', fontSize: 13.5, color: ON_GREEN_TINT, fontWeight: 700 }}>
