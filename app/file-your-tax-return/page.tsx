...
const faqs = [
  ...
  { q: 'Can I claim my van and fuel?', a: 'Yes. Either claim a share of your actual running costs, or use the flat mileage rate, which is 45p a mile for the first 10,000 business miles for 2025/26. That rate rises to 55p from April 2026, so it will be higher on next year’s records.' },
