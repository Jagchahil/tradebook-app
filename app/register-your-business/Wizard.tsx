      ...
      {finished && (
        <div className="wz-anim" style={{ textAlign: 'center' }}>
          ...
          <div style={{ maxWidth: 560, margin: '0 auto', background: INK, borderRadius: 20, padding: '30px 26px' }}>
            ...
            <h3 style={{ fontSize: 24, fontWeight: 800, color: '#fff', letterSpacing: '-0.5px', margin: '0 0 10px' }}>Try Lekhio free for 14 days.</h3>
            ...
            <Link href={OFFER_HREF} className="wz-btn" style={{ display: 'inline-block', background: RIVER, color: '#fff', fontSize: 16, fontWeight: 700, padding: '15px 34px', borderRadius: 12 }}>Start my 14 days free</Link>
            <p style={{ fontSize: 12.5, color: '#8A93A0', marginTop: 14 }}>14 days free, no card needed. Cancel any time before it ends and pay nothing.</p>
          </div>
