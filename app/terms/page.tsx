  ...
  return (
    <main style={{ backgroundColor: OFF_WHITE, color: INK, fontFamily: FONT, minHeight: '100vh' }}>
      ...
      <article style={{ maxWidth: 760, margin: '0 auto', padding: '24px 24px 80px' }}>
        ...
        <p style={para}>
          These terms set out the deal between you and TradeBook when you use our service. By creating
          an account or using TradeBook, you agree to them. Please read them. We have kept them plain.
        </p>

        <h2 style={heading}>What TradeBook does</h2>
        <p style={para}>
          TradeBook helps you capture receipts and expenses, keeps your books in order, and prepares
        ...
        <h2 style={heading}>What TradeBook is not</h2>
        <p style={para}>
          TradeBook is a tool, not your accountant or tax agent. We prepare figures for you to check.
          ...
          TradeBook. If your affairs are complex, speak to a qualified accountant.
        </p>

        <h2 style={heading}>Your account</h2>
        <ul style={{ paddingLeft: 20, margin: '0 0 14px' }}>
          <li style={li}>You must be 18 or over and trading as a UK sole trader to use TradeBook.</li>
        ...
        <ul style={{ paddingLeft: 20, margin: '0 0 14px' }}>
          <li style={li}>Your first 30 days are free. We will not charge you during the trial.</li>
          <li style={li}>After the trial, TradeBook costs £29 a month unless you cancel first.</li>
        ...
        <p style={para}>
          Use TradeBook for your own lawful business records. Do not use it to break the law, to
        ...
        <p style={para}>
          We work hard to keep TradeBook running, but we cannot promise it will always be available or
        ...
        <p style={para}>
          We provide TradeBook with reasonable care and skill. As far as the law allows, we are not
        ...
        <p style={para}>
          You can stop using TradeBook and close your account at any time. We may end your access if
        ...
        <p style={para}>Questions about these terms. Email support@tradebook.app.</p>
