...
const tools = [
  ...
  { href: '/mileage-calculator', icon: '🚗', title: 'Mileage claim calculator', body: 'Every business mile comes off your profit. See what yours are worth on the 2026/27 rates, and whether mileage beats buying the vehicle through the business.', tint: GREEN_TINT, fg: ON_GREEN_TINT, tag: 'Calculator' },
  ...
  { href: '/free-mtd-prep', icon: '🆓', title: 'Free MTD prep', body: 'For a straightforward return, profits, losses and the essentials, we will get your quarterly update ready free, forever. You send it to HMRC yourself. Join the list.', tint: GREEN_TINT, fg: ON_GREEN_TINT, tag: 'Coming soon' },
